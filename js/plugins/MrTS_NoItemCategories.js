...
(function() {
	...
	if (paramHideMenu)
	{
		...
		Scene_Item.prototype.createItemWindow = function() {
			// pieworkplace: change window position and size
		    var wy = this._helpWindow.height + Graphics.boxHeight * 0.25;
		    var wh = 0.5 * Graphics.boxHeight - this._helpWindow.height;
		    this._itemWindow = new Window_ItemList(48, wy, Graphics.boxWidth - 96, wh);
